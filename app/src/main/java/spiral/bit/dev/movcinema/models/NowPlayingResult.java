...
public class NowPlayingResult implements Parcelable {
    ...
    public final static Parcelable.Creator<NowPlayingResult> CREATOR = new Creator<NowPlayingResult>() {

        public NowPlayingResult createFromParcel(Parcel in) {
            return new NowPlayingResult(in);
        }
